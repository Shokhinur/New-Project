...
DATABASES = {
    'default': {
        ...
        'NAME': 'mydb', # database name in RDS is written here
        'USER': 'foo', # database master username in RDS is written here
        'PASSWORD': 'must_be_eight_characters',
        'HOST': 'writer.blogsh.link',  # database endpoint is written here
